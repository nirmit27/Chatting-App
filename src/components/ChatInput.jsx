...
export default function ChatInput(){
    ...
    return (
        ...
        value={inputValue} onChange={handleChange} onSubmit={handleSubmit} 
        ...
        <input type="submit" value="Send" class="ml-2 w-20 rounded-md bg-blue-600 p-2 text-white hover:cursor-pointer hover:bg-blue-800 focus:bg-blue-800 focus:outline-none transition ease-in-out delay-50 active:bg-blue-600" />
